...
This is a simple file with several methods for drawing. I tried to implement everything by myself, only with geometry and use a minimum amount of built-in functions.
